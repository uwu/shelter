...
The way we'll approach this is the same as most shelter plugins:
 ...
 - pull helpful information out of [_react fibers_](/guides/background)
 - modify the document manually

:::tip
You can read more about common patterns [here](/guides/patterns).
:::
...
If you want to read more about fibers, I suggest reading the [background](/guides/background) guide, but to TL;DR the relevant
