import type { SassPluginOptions, Type } from "./index";
import type { AcceptedPlugin, Postcss } from "postcss";
import PostcssModulesPlugin from "postcss-modules";
import type { BuildOptions, OnLoadResult } from "esbuild";
import type { Syntax } from "sass";
import { parse, resolve } from "path";
import { existsSync } from "fs";
import type { SyncOpts } from "resolve"; // TODO: use oxc-resolver
...
export function getContext(buildOptions: BuildOptions): PluginContext {
  ...
  return {
    ...
    // @ts-expect-error watch is not in buildOptions
