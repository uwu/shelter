...
const InternalButtonColors = {
  ...
  ACTIVE: {
    backgroundDefault: "var(--control-connected-background-default)",
    backgroundHover: "var(--control-connected-background-hover)",
    backgroundActive: "var(--control-connected-background-active)",
    textColorDefault: "var(--control-connected-text-default)",
    textColorHover: "var(--control-connected-text-hover)",
    textColorActive: "var(--control-connected-text-active)",
    borderColorDefault: "var(--control-connected-border-default)",
    borderColorHover: "var(--control-connected-border-hover)",
    borderColorActive: "var(--control-connected-border-active)",
  },
  OVERLAY_PRIMARY: {
